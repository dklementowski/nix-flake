{
  programs.plasma = {
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."35c52531-09b9-4dc3-a0e8-7da41b10af36" = "Domyślna";
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "1300,780";
      ...
      "khotkeysrc"."Data_1_1"."Comment" = "Uwaga";
      "khotkeysrc"."Data_1_1"."Enabled" = true;
      "khotkeysrc"."Data_1_1"."Name" = "Szukaj";
      ...
      "khotkeysrc"."Data_1_1Triggers"."Comment" = "Proste_działanie";
      ...
      "khotkeysrc"."Data_2"."Comment" = "Ta grupa zawiera różne przykłady pokazujące większość funkcji KHotkeys. (Ta grupa i wszystkie zawarte w niej działania są domyślnie wyłączone.)";
      "khotkeysrc"."Data_2"."DataCount" = 8;
      "khotkeysrc"."Data_2"."Enabled" = false;
      "khotkeysrc"."Data_2"."ImportId" = "kde32b1";
      "khotkeysrc"."Data_2"."Name" = "Przykłady";
      ...
      "khotkeysrc"."Data_2_1"."Comment" = "Po naciśnięciu Ctrl+Alt+I, będzie aktywowane okno KSIRC, jeśli istnieje. Proste.";
      "khotkeysrc"."Data_2_1"."Enabled" = false;
      "khotkeysrc"."Data_2_1"."Name" = "Uaktywnienie okna KSIRC";
      ...
      "khotkeysrc"."Data_2_1Actions0Window"."Comment" = "Okno KSIRC";
      ...
      "khotkeysrc"."Data_2_1Triggers"."Comment" = "Proste_działanie";
      ...
      "khotkeysrc"."Data_2_2Triggers"."Comment" = "Proste_działanie";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{b49e4e23-71e8-4d8e-b57a-83c59a95cc7f}";
      "khotkeysrc"."Data_2_3"."Comment" = "To działanie uruchamia Konsolę po naciśnięciu Ctrl+Alt+T.";
      "khotkeysrc"."Data_2_3"."Enabled" = false;
      "khotkeysrc"."Data_2_3"."Name" = "Uruchom Konsolę";
      ...
      "khotkeysrc"."Data_2_3Triggers"."Comment" = "Proste_działanie";
      ...
      "khotkeysrc"."Data_2_4Conditions0Window0"."Title" = "Qt Designer autorstwa Trolltech";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{4fc18a72-8161-4bed-9002-a63b835ed1b6}";
      "khotkeysrc"."Data_2_5"."Comment" = "Po naciśnięciu Ctrl+Alt+W zostanie wykonane wywołanie D-Bus, które spowoduje pokazanie mini-terminala. Możesz używać dowolnych wywołań D-Bus, tak jak przy wykorzystaniu programu wiersza poleceń \"qdbus\".";
      "khotkeysrc"."Data_2_5"."Enabled" = false;
      "khotkeysrc"."Data_2_5"."Name" = "Wykonaj wywołanie D-Bus 'qdbus org.kde.krunner /App display'";
      ...
      "khotkeysrc"."Data_2_5Triggers"."Comment" = "Proste_działanie";
      ...
      "khotkeysrc"."Data_2_6Actions0DestinationWindow"."Comment" = "Okno XMMS";
      ...
      "khotkeysrc"."Data_2_6Actions0DestinationWindow0"."Comment" = "Okno odtwarzacza XMMS";
      ...
      "khotkeysrc"."Data_2_6Triggers"."Comment" = "Proste_działanie";
      ...
      "khotkeysrc"."Data_2_7_1"."Name" = "Wstecz";
      ...
      "khotkeysrc"."Data_2_7_1Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_2_7_2"."Name" = "Naprzód";
      ...
      "khotkeysrc"."Data_2_7_2Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_2_7_3"."Name" = "W górę";
      ...
      "khotkeysrc"."Data_2_7_3Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_2_7_4"."Name" = "Wczytaj ponownie";
      ...
      "khotkeysrc"."Data_2_7_4Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_2_8"."Comment" = "Po naciśnięciu Win+E (Tux+E) zostanie uruchomiona przeglądarka WWW, w której zostanie otwarta strona http://www.kde.org . W mini-terminalu (Alt+F2) można wydawać wszystkie rodzaje poleceń.";
      "khotkeysrc"."Data_2_8"."Enabled" = false;
      "khotkeysrc"."Data_2_8"."Name" = "Przejdź do strony KDE";
      ...
      "khotkeysrc"."Data_2_8Triggers"."Comment" = "Proste_działanie";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{4d08a274-79e9-4cc6-9ce2-d4e51c352e83}";
      "khotkeysrc"."Data_3"."Comment" = "Podstawowe gesty w Konquerorze";
      "khotkeysrc"."Data_3"."DataCount" = 14;
      "khotkeysrc"."Data_3"."Enabled" = true;
      "khotkeysrc"."Data_3"."ImportId" = "konqueror_gestures_kde321";
      "khotkeysrc"."Data_3"."Name" = "Gesty w Konquerorze";
      "khotkeysrc"."Data_3"."SystemGroup" = 0;
      "khotkeysrc"."Data_3"."Type" = "ACTION_DATA_GROUP";
      "khotkeysrc"."Data_3Conditions"."Comment" = "Okno Konquerora";
      ...
      "khotkeysrc"."Data_3_1"."Comment" = "Naciśnij, w lewo, puść.";
      "khotkeysrc"."Data_3_1"."Enabled" = true;
      "khotkeysrc"."Data_3_1"."Name" = "Wstecz";
      "khotkeysrc"."Data_3_1"."Type" = "SIMPLE_ACTION_DATA";
      "khotkeysrc"."Data_3_10"."Comment" = "Styl Opery: naciśnij, do góry, puść.\nUWAGA: Konflikt z 'Nowa karta', więc jest domyślnie wyłączone.";
      "khotkeysrc"."Data_3_10"."Enabled" = false;
      "khotkeysrc"."Data_3_10"."Name" = "Zatrzymaj wczytywanie";
      ...
      "khotkeysrc"."Data_3_10Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_11"."Comment" = "Przejście wyżej w strukturze URL/katalogu.\nStyl Mozilli: naciśnij, do góry, w lewo, do góry, puść.";
      "khotkeysrc"."Data_3_11"."Enabled" = true;
      "khotkeysrc"."Data_3_11"."Name" = "W górę";
      ...
      "khotkeysrc"."Data_3_11Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_12"."Comment" = "Przejście wyżej w strukturze URL/katalogu.\nStyl Mozilli: naciśnij, do góry, w lewo, do góry, puść.\nUWAGA: Konflikt z \"Uaktywnij poprzednią kartę\", więc domyślnie wyłączone.";
      "khotkeysrc"."Data_3_12"."Enabled" = false;
      "khotkeysrc"."Data_3_12"."Name" = "W górę 2 razy";
      ...
      "khotkeysrc"."Data_3_12Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_13"."Comment" = "Naciśnij, w górę, w prawo, puść.";
      "khotkeysrc"."Data_3_13"."Enabled" = true;
      "khotkeysrc"."Data_3_13"."Name" = "Uaktywnij następną kartę";
      ...
      "khotkeysrc"."Data_3_13Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_14"."Comment" = "Naciśnij, w górę, w lewo, puść.";
      "khotkeysrc"."Data_3_14"."Enabled" = true;
      "khotkeysrc"."Data_3_14"."Name" = "Uaktywnij poprzednią kartę";
      ...
      "khotkeysrc"."Data_3_14Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_1Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_2"."Comment" = "Naciśnij, w dół, w górę, w dół, puść.";
      "khotkeysrc"."Data_3_2"."Enabled" = true;
      "khotkeysrc"."Data_3_2"."Name" = "Powiel kartę";
      ...
      "khotkeysrc"."Data_3_2Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_3"."Comment" = "Naciśnij, w dół, w górę, puść.";
      "khotkeysrc"."Data_3_3"."Enabled" = true;
      "khotkeysrc"."Data_3_3"."Name" = "Powiel okno";
      ...
      "khotkeysrc"."Data_3_3Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_4"."Comment" = "Naciśnij, w prawo, puść.";
      "khotkeysrc"."Data_3_4"."Enabled" = true;
      "khotkeysrc"."Data_3_4"."Name" = "Naprzód";
      ...
      "khotkeysrc"."Data_3_4Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_5"."Comment" = "Naciśnij, w dół, lekko w górę, w prawo, w dół, puść.\n(rysowanie małego \"h\")";
      "khotkeysrc"."Data_3_5"."Enabled" = true;
      "khotkeysrc"."Data_3_5"."Name" = "Katalog domowy";
      ...
      "khotkeysrc"."Data_3_5Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_6"."Comment" = "Naciśnij, w prawo, w dół, w prawo, puść.\nStyl Mozilli: naciśnij, w dół, w prawo, puść.";
      "khotkeysrc"."Data_3_6"."Enabled" = true;
      "khotkeysrc"."Data_3_6"."Name" = "Zamknij kartę";
      ...
      "khotkeysrc"."Data_3_6Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_7Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_8"."Comment" = "Naciśnij, przesuń w dół, puść.";
      "khotkeysrc"."Data_3_8"."Enabled" = true;
      "khotkeysrc"."Data_3_8"."Name" = "Nowe okno";
      ...
      "khotkeysrc"."Data_3_8Triggers"."Comment" = "Wyzwalacze_gestów";
      ...
      "khotkeysrc"."Data_3_9"."Comment" = "Naciśnij, przesuń w górę, przesuń w dół, puść.";
      "khotkeysrc"."Data_3_9"."Enabled" = true;
      "khotkeysrc"."Data_3_9"."Name" = "Wczytaj ponownie";
      ...
      "khotkeysrc"."Data_3_9Triggers"."Comment" = "Wyzwalacze_gestów";
